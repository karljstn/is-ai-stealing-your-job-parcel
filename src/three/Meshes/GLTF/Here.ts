...
class Here extends withMouse implements ThreeGLTF {
	params: any
	...
	initialize = () => {
		...
		this.setTransition(MODELS.HERE.SCALE, new Vector3(0.2, 0, 0))
		this.in()
		this.tweaks()
	}
	...
	tweaks = () => {
		...
		const folder = store.state.tweakpane.addFolder({ title: 'Here', expanded: false })
