    ...
    <section>
        <div class="section-1" ref="section1">
            <div class="container">
                ...
                <p>
                    As we have no precedent for something resembling the rise of AI, we can't reliably predict
                    what's coming.
                </p>
        ...
        <div class="section-3" ref="section3">
            ...
            <div class="container container-right">
                <div class="content">
                    <h2>We also know</h2>
                    <p class="p2">
                        That our actions in this field will have far-reaching consequences, and the way that
                        we'll use AI will greatly influence our future.
                    </p>
                </div>
            ...
            <div class="container">
                <div class="content">
                    ...
                    <p class="p3">
                        Wealth created by the AI workforce could be redistributed equitably, so that people
...
export default Vue.extend({
    ...
    mounted() {
        ...
        this.parallax = [this.$refs.calendar, this.$refs.hammer, this.$refs.pendule, this.$refs.puzzle]
