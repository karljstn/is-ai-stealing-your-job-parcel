<template>
	<section>
		<div class="section-1" ref="section1">
			<div class="container">
				<h1 class="in-reality">In reality, the future is <span>uncertain</span>.</h1>
				<p>
					As we have no precedent for something resembling the rise of AI, we can't reliably predict what's
					coming.
				</p>
		...
		<div class="section-2" ref="section2">
			...
			<h2 class="h2-1">
				Whether "strong" AI will have a positive or negative impact on our lives,
			</h2>
			<div class="impact-ui">
				<div class="ui1">
			...
			<h3>
				<span class="first-line"> <span class="stats">50% </span>probability </span>
			...
			<div class="right-container">
				<h2 class="h2-2">
					When should this type of "strong" AI come to be, or if it'll ever happen at all
				</h2>
			</div>
			...
			<div class="right-container bottom-container">
				<p>
					...
					<span class="last-line">field have a low chance of being replaced</span>
				</p>
				<div class="balls"></div>
			</div>
		...
		<div class="section-3" ref="section3">
			<div class="container">
				<div class="content">
					...
					<p class="p1">
						Today's AI is excellent at very specific tasks, but it falters at multitasking, and is
						definitely not at the level of general problem solving that humans can be.
					</p>
				</div>
				<div class="img puzzle"></div>
			</div>
			<div class="container container-right">
				<div class="content">
					<h2>We also know</h2>
					<p class="p2">
						That our actions in this field will have far-reaching consequences, and the way that we'll use
						AI will greatly influence our future.
					</p>
				</div>
				<div class="img pendule"></div>
			</div>
			<div class="container">
				<div class="content">
					<h2>In a perfect world,</h2>
					<p class="p3">
						Wealth created by the AI workforce could be redistributed equitably, so that people could live
						lives free of menial labor.
					</p>
				</div>
