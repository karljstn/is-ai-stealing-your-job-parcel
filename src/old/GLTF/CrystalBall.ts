...
// class CrystalBall extends MouseGLTF implements ThreeGLTF {
// 	params: any
// 	loader: GLTFLoader
...
// 		this.params = {
// 			size: MODELS.CRYSTAL_BALL.BASE_SCALE,
...
// 		this.setTransition(MODELS.CRYSTAL_BALL.BASE_SCALE, this.group.position, new Vector3(0, 0, 0),)
