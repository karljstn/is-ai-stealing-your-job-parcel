...
class HandOK extends MouseGLTF implements ThreeGLTF {
	...
	tweaks = () => {
		...
		const sizeInput = folder.addInput(this.params, 'size', { label: "Hand size", min: MODELS.HAND_OK.BASE_SCALE * 0.33, max: MODELS.HAND_OK.BASE_SCALE * 3 })
