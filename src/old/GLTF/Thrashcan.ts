...
class Trashcan extends TweenGLTF implements ThreeGLTF {
	params: {
	...
	initialize = () => {
		...
		this.setTransition(MODELS.TRASHCAN.BASE_SCALE, this.original.position, new Vector3(0, -0.3, 0), { in: 0, out: 0 }, this.params.out.duration)
	}
